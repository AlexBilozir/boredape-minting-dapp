    ...
    <div className="min-h-screen h-full w-full flex flex-col bg-brand-background overflow-hidden">
      ...
      <header className="min-w-full py-8 px-4 md:px-0">
        ...
        <div className="flex flex-wrap mt-4 justify-center space-x-4 md:space-x-12">
            ...
            <div>
            <a href="https://etherscan.io/address/0x79e7ba29f7597ca06fcc5de7694a50a5de529faf" className="m-6" target="_blank" rel="noopener noreferrer"><img src="images/etherscan.png" width="45" alt="Official Contract Page" className="transform hover:scale-110"/></a>
        ...
        <div className="flex flex-col items-center max-w-5xl w-full">
          ...
          <div className="flex flex-col md:flex-row md:space-x-16 space-y-6 items-center mt-2 w-full">
            ...
            <div className="flex flex-col  items-center justify-center text-center Montserrat-UltraLight text-brand-red px-4 md:px-0 ">
              ...
              <div className="flex flex-wrap mt-4 justify-center space-x-4 md:space-x-12">
                <div>
                 <a href="https://ipfs.io/ipfs/QmUTsuDfWftTqyMwLC1YinFo1NaYLMhpfCkenbtQUc7H2W" target="_blank" rel="noreferrer noopener" className="font-bold text-2xl Montserrat-Light-Alt1 uppercase m-4">#1</a>
                </div>
                <div>
                 <a href="https://ipfs.io/ipfs/QmNqcSdPjZRMewVPcykRb8xCLCzUk1wQu8bwL4w8dD9NNS" target="_blank" rel="noreferrer noopener" className="font-bold text-2xl Montserrat-Light-Alt1 uppercase m-4">#2</a>
                </div>
                <div>
                 <a href="https://ipfs.io/ipfs/QmWUZcrotu3CRgqeFBHU4F3e8aZTzcHRt7Jo3pkFW9115a" target="_blank" rel="noreferrer noopener" className="font-bold text-2xl Montserrat-Light-Alt1 uppercase m-4">#3</a>
                </div>
                <div>
                 <a href="https://ipfs.io/ipfs/QmdkAqSrcB7gT4zZj6cCFikiDPembK5oEuks8wCtEWNEwC" target="_blank" rel="noreferrer noopener" className="font-bold text-2xl Montserrat-Light-Alt1 uppercase m-4">#4</a>
                </div>
                <div>
                 <a href="https://ipfs.io/ipfs/QmXgcNHN26aJFoAHgaFUqzKG6viRPiE7BtCoefnWDAuze8" target="_blank" rel="noreferrer noopener" className="font-bold text-2xl Montserrat-Light-Alt1 uppercase m-4">#5</a>
                </div>
